...
local function create_commands()
  ...
  vim.api.nvim_create_user_command(
    ...
    function() M.find_or_create_project_note() end,
    { desc = "Create today journal note" }
  )
end
...
function M.find_or_create_note(opts) require("plugins.custom.zk.note").find_or_create_note(opts) end

function M.find_or_create_note_without_picker(opts)
  require("plugins.custom.zk.note").find_or_create_note_without_picker(opts)
end

function M.find_or_create_project_note() require("plugins.custom.zk.note").find_or_create_project_note() end

function M.open_notes() require("plugins.custom.zk.note").open_notes() end

function M.annotate_task() require("plugins.custom.zk.note").annotate_task() end
